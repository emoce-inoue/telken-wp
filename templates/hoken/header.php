...
<html lang="ja">
  <head>
    ...
    <meta content="<?php echo get_template_directory_uri(); ?>/assets/images/hoken/og-image.png" property="og:image" />
    <meta content="ja_JP" property="og:locale" />
    <!-- favicon -->
    <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/assets/images/hoken/favicon.ico" />
    <link rel="icon" type="image/webp" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/assets/images/hoken/favicon.webp" />
    <!-- css/js -->
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/assets/css/hoken/style.css" rel="stylesheet">
    <?php
